      ...
      <div className="space-y-2">
        ...
        {Object.entries(distribution).map(([guessCount, count]) => (
          <div key={guessCount} className="flex items-center text-sm font-medium">
            ...
            <div className="flex-grow bg-gray-200 dark:bg-[#444444] rounded-sm h-5 ltr:ml-2 rtl:mr-2">
              <div
                className="bg-[#E96306] h-5 rounded-sm flex items-center text-white font-bold ltr:justify-end ltr:pr-2 rtl:justify-start rtl:pl-2"
