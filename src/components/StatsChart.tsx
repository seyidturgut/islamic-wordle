      ...
      <div className="space-y-2">
        {Object.entries(distribution).map(([guessCount, count]) => (
          <div key={guessCount} className="flex items-center text-sm font-medium">
            ...
            <div className="flex-grow bg-gray-200 dark:bg-gray-700 rounded-sm h-5 ml-2">
              <div
                className="bg-emerald-600 h-5 rounded-sm flex items-center justify-end pr-2 text-white font-bold"
